        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="bg-white mt-12 lg:mt-0 p-8 rounded-lg shadow-xl border border-gray-200">
            ...
            <p className="text-lg mb-4 text-gray-700">
              Have an enquiry? Send us a message using the form below and we’ll
              get back to you as soon as possible.
            </p>
            <p className="text-sm mb-8 text-blue-600 underline cursor-pointer">
              Job seekers contact us here
            </p>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button
                type="submit"
                className={`btn btn-primary w-full mt-4 p-3 rounded-lg bg-pink-600 text-white hover:bg-pink-700 focus:outline-none focus:ring-2 focus:ring-pink-500/50 ${loading ? 'loading' : ''}`}
                disabled={loading}
              >
          ...
          <div className="p-6">
            ...
            <div className="space-y-6 text-gray-700">
              <div>
                ...
                <p>
                  Level 16, Menara AIA Cap Square, <br /> No. 10, Jalan Munshi
                  Abdullah
                </p>
                <p>Kuala Lumpur 50100</p>
                <p>
                  Customer Service and Sales:{' '}
                  <a href="tel:+60327789000" className="text-blue-600">
                    +60 3 2778 9000
                  </a>
                </p>
              </div>
              <div>
                ...
                <p>
                  432, 433 & 435 L3A-2, Lv 3A, SPICE Arena, <br /> 180, Jalan
                  Tun Dr. Awang, Relau
                </p>
                <p>Penang 11900</p>
              </div>
              <div>
                ...
                <p>
                  19-18, Lv 19, Austin 18 Versatile Business Suites, <br />
                  Jalan Austin Perdana 3, <br />
